...
class CandidatsController extends Controller
{
    ...
    {
        $candidats= User::all()->where('role', 'candidat');
    ...
    public function storeFormation(Request $request, $id)
    {
        ...
        return redirect()->route('candidats.show', $id)->with('Message','Candidature ajoute avec succes');
    }

    public function removeFormation(Request $request, $id)
    {
            $candidat = User::findOrFail($id);
            $formation = Formation::findOrFail($request->formation_id);
            $candidat->formations()->detach($formation);
            
            return redirect()->route('candidats.show', $id)->with('Message','Candidature supprimée avec succès');
    }
}
